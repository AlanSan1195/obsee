      ...
      <div className="p-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="rounded-none bg-primary px-4 py-2.5 text-sm font-bold lowercase tracking-terminal text-background shadow-[0_0_26px_-8px_rgba(94,255,159,0.6)] transition-all hover:bg-primary-hover"
          >
            {confirmLabel}
          </button>
        </div>
